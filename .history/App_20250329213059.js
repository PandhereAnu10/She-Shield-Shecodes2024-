...
const { LightTheme, DarkTheme } = adaptNavigationTheme({
  reactNavigationLight: NavigationContainer.DefaultTheme,
  reactNavigationDark: NavigationContainer.DarkTheme,
});
...
export default function App() {
  ...
  const paperTheme = isDarkMode ? { ...MD3DarkTheme, ...darkTheme } : { ...MD3LightTheme, ...lightTheme };
