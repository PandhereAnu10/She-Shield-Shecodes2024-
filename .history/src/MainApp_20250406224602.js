...
import { View, Text, StyleSheet, Dimensions, TouchableOpacity, Image, SafeAreaView, StatusBar } from 'react-native';
...
const MainApp = () => {
  ...
  return (
    <SafeAreaView style={styles.mainContainer}>
      <StatusBar backgroundColor="#3D212B" barStyle="light-content" />
